...
loaded_discharge = np.load('/ec/res4/hpcperm/ecmv6565/forecast_analysis/discharge_array.npy')  # Shape: (90, 51, 60, 5695)
...
loaded_discharge= loaded_discharge[:90, :, :, :] # 90 for the full length of the array 3 months 
observation_array= observation_array[:90,:, :]

crps_dict = calculate_crps_sequential(loaded_discharge, observation_array)

# Save results
output_path = "/ec/res4/hpcperm/ecmv6565/forecast_analysis/crps_results.pkl"
