...
observation_array = np.load('/ec/res4/hpcperm/ecmv6565/forecast_analysis/observation_array_jan_march.npy')  # Shape: (90, 60, 5695)
...
base_dir = "/ec/res4/hpcperm/ecmv6565/fillup/fillup_series"
...
# Save as .npy file
np.save("/ec/res4/hpcperm/ecmv6565/forecast_analysis/persistence_forecast_array.npy", persistence_forecast)
...
crps_persistence_dict = calculate_crps_persistence(persistence_forecast, observation_array)

# Save results
print("Saving results...")
crps_output_path = "/ec/res4/hpcperm/ecmv6565/forecast_analysis/crps_persistence_results.pkl"
...
print("Results saved:")
print(f"- CRPS results: {crps_output_path}")
