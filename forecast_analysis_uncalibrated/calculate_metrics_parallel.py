...
# Load data
forecast_path = "/ec/res4/hpcperm/ecmv6565/forecast_analysis_uncalibrated/discharge_array.npy"
observation_path = "/ec/res4/hpcperm/ecmv6565/forecast_analysis_uncalibrated/observation_array_jan_march.npy"
...
#trimmed_observation_array = observation_array[:num_days, :, :] # jsut put this in case the forecast array is differnt size than the observed

print("Starting metric calculations for ensemble 0...")
metrics_dict = calculate_metrics(loaded_discharge, observation_array)

# Save results
output_path = "/ec/res4/hpcperm/ecmv6565/forecast_analysis_uncalibrated/metrics_calculated_slurm.pkl"
